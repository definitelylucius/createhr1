...
class AdminPController extends Controller
{
    public function index()
    {
        ...
        return view('admin.recruitment.pre_employment', compact(
    ...
    public function showScheduleForm()
    {
        ...
        return view('admin.recruitment.schedule_pre_employment', [
    ...
    public function schedule(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.recruitment.pre-employment.index')
    ...
    public function showDocuments(JobApplication $application)
    {
        ...
        return view('admin.recruitment.pre_employment_documents', compact('application', 'document'));
    }
