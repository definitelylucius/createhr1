            ...
            <div class="container mx-auto px-4 py-6">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('admin.recruitment.scheduleExam') }}" class="btn btn-primary shadow-sm hover:shadow-md transition-shadow">
...
<script>
    function openCompleteModal(applicationId) {
        ...
        form.action = `/admin/recruitment/exams/${applicationId}/complete`;
    ...
    function showEvaluationDetails(evaluationId) {
        fetch(`/admin/recruitment/exams/evaluations/${evaluationId}`)
