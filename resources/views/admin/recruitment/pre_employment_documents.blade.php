...
@endif
                    ...
                    <form action="{{ route('admin.recruitment.pre-employment.verify-document', ['application' => $application->id, 'documentType' => $docType]) }}" method="POST" class="flex items-center gap-4" onsubmit="return confirm('Are you sure you want to verify this document?')">
                        @csrf
                        <div class="flex items-center">
...
<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4"><!-- Changed back to 3 columns -->
        ...
        <div class="border border-gray-200 rounded-lg p-4">
            ...
            <form action="{{ route('admin.recruitment.pre-employment.update-reference-check', ['application' => $application->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to update the reference check status?')">
                @csrf
                @method('PUT')
                <div class="mb-3">
...
<div class="border border-gray-200 rounded-lg p-4">
    ...
    <form action="{{ route('admin.recruitment.pre-employment.update-drug-test', ['application' => $application->id]) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to update the drug test status?')">
        @csrf
        @method('PUT')
        <div class="mb-3">
...
<div class="border border-gray-200 rounded-lg p-4">
    ...
    <form action="{{ route('admin.recruitment.pre-employment.update-medical-exam', ['application' => $application->id]) }}" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to update the medical exam status?')">
        @csrf
        @method('PUT')
