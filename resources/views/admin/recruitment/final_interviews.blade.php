            ...
            <div class="container mx-auto px-4 py-6">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('admin.recruitment.scheduleFinalInterview') }}" class="btn btn-primary">
    ...
    @endif
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <div class="flex space-x-2">
                                                <!-- Pass Button -->
                                                <form method="POST" action="{{ route('admin.recruitment.final-interviews.update-result', $interview) }}">
                                                    @csrf
                                                    @method('PUT')
                                                ...
                                                <!-- Fail Button -->
                                                <form method="POST" action="{{ route('admin.recruitment.final-interviews.update-result', $interview) }}" class="ml-2">
                                                    @csrf
                                                    @method('PUT')
