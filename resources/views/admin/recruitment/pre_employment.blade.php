            ...
            <div class="container mx-auto px-4 py-6">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('admin.recruitment.pre-employment.schedule') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
    ...
    @endif
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($application->preEmploymentDocument)
                                                <a href="{{ route('admin.recruitment.pre-employment.documents', $application->id) }}" class="flex items-center focus:outline-none">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-end space-x-2">
                                                <a 
                                                    href="{{ route('admin.recruitment.pre-employment.documents', $application->id) }}"
...
<div id="documentRequestModal" class="fixed z-50 inset-0 overflow-y-auto hidden">
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <form method="POST" action="{{ route('admin.recruitment.pre-employment.request-documents', ['application' => 'APPLICATION_ID_PLACEHOLDER']) }}" id="documentRequestForm">
                @csrf
