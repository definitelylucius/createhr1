            ...
            <main class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 card-hover transition-all">
                        ...
                        <a href="{{ route('staff.recruitment.applicants') }}" class="inline-flex items-center mt-4 text-sm font-medium text-blue-600 hover:text-blue-800">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 card-hover transition-all">
                        ...
                        <a href="{{ route('staff.recruitment.initial_interviews') }}" class="inline-flex items-center mt-4 text-sm font-medium text-purple-600 hover:text-purple-800">
                            View all <i class="fas fa-arrow-right ml-1 text-xs"></i>
                        </a>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 card-hover transition-all">
                        ...
                        <a href="{{ route('staff.recruitment.demos') }}" class="inline-flex items-center mt-4 text-sm font-medium text-yellow-600 hover:text-yellow-800">
                            View all <i class="fas fa-arrow-right ml-1 text-xs"></i>
                        </a>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 card-hover transition-all">
                        ...
                        <a href="{{ route('staff.recruitment.exams') }}" class="inline-flex items-center mt-4 text-sm font-medium text-green-600 hover:text-green-800">
                            View all <i class="fas fa-arrow-right ml-1 text-xs"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 card-hover transition-all">
                        ...
                        <a href="{{ route('staff.recruitment.final_interviews') }}" class="inline-flex items-center mt-4 text-sm font-medium text-indigo-600 hover:text-indigo-800">
                            View all <i class="fas fa-arrow-right ml-1 text-xs"></i>
                        </a>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 card-hover transition-all">
                        ...
                        <a href="{{ route('staff.recruitment.pre_employment') }}" class="inline-flex items-center mt-4 text-sm font-medium text-orange-600 hover:text-orange-800">
                            View all <i class="fas fa-arrow-right ml-1 text-xs"></i>
                        </a>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 card-hover transition-all">
                        ...
                        <a href="{{ route('staff.recruitment.onboarding') }}" class="inline-flex items-center mt-4 text-sm font-medium text-teal-600 hover:text-teal-800">
                            View all <i class="fas fa-arrow-right ml-1 text-xs"></i>
                        </a>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-4 border-t border-gray-100">
                            <a href="{{ route('staff.recruitment.initial_interviews') }}" class="text-sm font-medium text-purple-600 hover:text-purple-800 inline-flex items-center">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-4 border-t border-gray-100">
                            <a href="{{ route('staff.recruitment.demos') }}" class="text-sm font-medium text-yellow-600 hover:text-yellow-800 inline-flex items-center">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <a href="{{ route('staff.recruitment.exams') }}" class="text-sm font-medium text-green-600 hover:text-green-800 inline-flex items-center">
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <a href="{{ route('staff.recruitment.final_interviews') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-800 inline-flex items-center">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <a href="{{ route('staff.recruitment.pre_employment') }}" class="text-sm font-medium text-orange-600 hover:text-orange-800 inline-flex items-center">
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        ...
                        <a href="{{ route('staff.recruitment.onboarding') }}" class="text-sm font-medium text-teal-600 hover:text-teal-800 inline-flex items-center">
